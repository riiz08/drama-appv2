      ...
      >
        <div className="group relative block rounded-lg overflow-hidden bg-zinc-900 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-red-500/20 h-full">
          ...
          <div className="relative w-full pb-[150%] overflow-hidden bg-zinc-800">
            ...
            {/* Overlay on Hover */}
            <div
              className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"
              aria-hidden="true"
            />
            ...
            {drama.totalEpisode && (
              <div className="absolute bottom-2 left-2 z-10">
                <Chip
                  ...
                  aria-label={`${drama.totalEpisode} episod`}
                >
